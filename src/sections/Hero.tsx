    ...
    <section ref={sectionRef} className="relative w-full min-h-[100dvh] overflow-hidden flex items-end">
      ...
      <div ref={textRef} className="relative z-10 w-full px-5 md:px-10 pb-12 md:pb-20">
        <div className="max-w-[600px]">
          ...
          <p className="hero-desc text-base md:text-lg text-white/60 leading-relaxed max-w-md mb-8 font-dmsans">
            Nossa ultima coleção: basics de algodão organico e peças premium, feitas no Brasil.
          </p>
          <button
